<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AdminEmailSending.aspx.cs" Inherits="ITLDashboard.Modules.AdminPannel.AdminEmailSending" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="container" style="width: 100%; margin-top: 20px;">
        ...
        <div class="row">
            ...
            <div class="col-sm-7">
                <p style="font-family: inherit; font-size: 35px !important; font-weight: normal; color: hsla(160, 10%, 18%, 0.35)">Email Sending Form</p>
                ...
                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel">
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2" id="SearchForm" runat="server">
                                Form ID
                                     <asp:TextBox ID="txtFormID" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                            <div class="col-sm-4">
                                Form Name
                            ...
                            <div class="col-sm-2">
                                <br />
                                <asp:Button ID="btnSearch" Text="Search" CssClass="btn btn-primary" runat="server" OnClick="btnSearch_Click"></asp:Button>
                            </div>
                        </div>
