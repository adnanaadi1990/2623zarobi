<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Inventorymanagement_Main.aspx.cs" Inherits="ITLDashboard.Modules.Inventorymanagement.Inventorymanagement_Main" %>
...
<head>
    ...
    <script type="text/javascript">
        function DivClickedDS() {
            var btnHiddenbDS = $('#<%= btnDS.ClientID %>');
            if (btnHiddenbDS != null) {
                btnHiddenbDS.click();
            }
        }
                ...
                <div class="row no-gutter">
                    <div class="col-lg-4 col-sm-6">
                        <a href="#" class="portfolio-box">
                            <asp:ImageButton ID="btnDS" runat="server" CssClass="img-responsive" ImageUrl="~/img/portfolio/D.S.jpg" OnClick="btnDS_Click" />
                            <%--<img src="../../img/portfolio/VMC.png" class="img-responsive" alt="">--%>
                            <div class="portfolio-box-caption" onclick="javascript:DivClickedDS(); return true;">
                      ...
                      <div class="col-lg-4 col-sm-6">
                        <a href="#" class="portfolio-box">
                            <asp:ImageButton ID="btnIAF" runat="server" CssClass="img-responsive" ImageUrl="~/img/portfolio/I.A.jpg" OnClick="btnIAF_Click" />
                            <%--<img src="../../img/portfolio/VMC.png" class="img-responsive" alt="">--%>
