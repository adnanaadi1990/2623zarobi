<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="SearchAssetCreationForm.aspx.cs" Inherits="ITLDashboard.Modules.Annexure.SearchAssetCreationForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="container" style="width: 100%; margin-top: 20px;" id="dvcnt">
        ...
        <div class="panel panel-default" id="pnlPC">
            <div class="panel-heading">Search Asset Creation Form</div>
