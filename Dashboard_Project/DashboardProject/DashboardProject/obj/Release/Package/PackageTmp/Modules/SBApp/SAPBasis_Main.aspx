<%@ Page Title="" Language="C#"  AutoEventWireup="true" CodeBehind="SAPBasis_Main.aspx.cs" Inherits="ITLDashboard.Modules.SBApp.SAPBasis_Main" %>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Users Rights Application</title>
    ...
    <script type="text/javascript">
        function DivClickedUAF() {
            var btnHiddenbUAF = $('#<%= btnUAF.ClientID %>');
            if (btnHiddenbUAF != null) {
                btnHiddenbUAF.click();
            }
        }

        function DivClickedTRF() {
            var btnHiddenbTRF = $('#<%= btnTRF.ClientID %>');
            if (btnHiddenbTRF != null) {
                btnHiddenbTRF.click();
            }
        }
                ...
                <div class="row no-gutter">
                      <div class="col-lg-4 col-sm-6">
                       <a href="#" class="portfolio-box">
                         <asp:ImageButton ID="btnUAF" runat="server" CssClass="img-responsive" ImageUrl="~/img/portfolio/SAPUserAut.jpg" CausesValidation="False" OnClick="btnUAF_Click"></asp:ImageButton>
                            <%--<img src="../../img/portfolio/CM.jpg" class="img-responsive" alt="">--%>
                            <div class="portfolio-box-caption">
                                <div class="portfolio-box-caption-content" onclick="javascript:DivClickedUAF(); return true;">
...
<div class="col-lg-4 col-sm-6">
                       <a href="#" class="portfolio-box">
                         <asp:ImageButton ID="btnTRF" runat="server" CssClass="img-responsive" ImageUrl="~/img/portfolio/TransportRequestForm.jpg" CausesValidation="False" OnClick="btnTRF_Click"></asp:ImageButton>
                            <%--<img src="../../img/portfolio/CM.jpg" class="img-responsive" alt="">--%>
                            <div class="portfolio-box-caption">
