<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AdminApprovalForm.aspx.cs" Inherits="ITLDashboard.Modules.AdminPannel.AdminApprovalForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <div class="container" style="width: 100%; margin-top: 20px;">
        ...
        <div class="row">
            ...
            <div class="col-sm-7">
                <p style="font-family: inherit; font-size: 35px !important; font-weight: normal; color: hsla(160, 10%, 18%, 0.35)">User Entry Form</p>
                ...
                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel">
                    <div class="panel-body">
                            ...
                            <div class="col-sm-12">
                                Select Entry Type
                                     ...
                                     <asp:RadioButtonList ID="RBList" runat="server" RepeatDirection="Horizontal" AutoPostBack="True" OnSelectedIndexChanged="RBList_SelectedIndexChanged">
                                         <asp:ListItem Value="tbluser">New User Entry</asp:ListItem>
                                         <asp:ListItem Value="tbluserApproval">Entry For Approval</asp:ListItem>
                                         <asp:ListItem Value="tbluserReviwer">Entry For reviewer</asp:ListItem>
                                         <asp:ListItem Value="tbluserMDA">Entry For MDA</asp:ListItem>
                                         <asp:ListItem Value="tbl_EmailToSpecificPerson">Entry for Notification User</asp:ListItem>
                                     </asp:RadioButtonList>
                            </div>
                        </div>
                        <span class="help-block"></span>

                        <div class="row" id="dvNewUser" runat="server" visible="false">
                            <div class="col-sm-4">
                                Display Name
                            ...
                            <div class="col-sm-4">
                                Email ID
                                    <asp:TextBox ID="txtEmailID" runat="server" CssClass="form-control" CausesValidation="True" Height="34px" TextMode="Email"></asp:TextBox>
                            </div>

                        </div>
                        <span class="help-block"></span>

                        <div class="row" id="dvAllUser" runat="server" visible="false">
                            <div class="col-sm-3">
                                Display Name
                            ...
                            <div class="col-sm-3">
                                ...
                                <asp:HiddenField ID="hfUserNameupdate" runat="server" />
                            </div>
                        </div>
                        ...
                        <div class="row">
                                ...
                                <div class="col-sm-8" id="AlphabetPager" runat="server"  Visible="false">
                                      &nbsp;<div class="AlphabetPager"  style="font-weight: 800;" >
