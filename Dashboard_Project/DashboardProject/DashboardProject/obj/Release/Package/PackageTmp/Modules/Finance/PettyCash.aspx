<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="PettyCash.aspx.cs" Inherits="ITLDashboard.Modules.Finance.PettyCash" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container" style="width: 100%; margin-top: 20px;">
        ...
        <div id="pnlPC">
            ...
            <div class="row">
                ...
                <div class="col-sm-7" id="pnlHD">
                    <p style="font-family: inherit; font-size: 35px !important; font-weight: normal; color: hsla(160, 10%, 18%, 0.35)">Petty Cash</p>
                </div>
            </div>
                                ...
                                <div class="col-sm-4">
                                    Accountant  
                                       <asp:DropDownList ID="ddlEmailMDA" CssClass="form-control" runat="server">
                                           <asp:ListItem Value="Sabir">Sabir</asp:ListItem>
                                       </asp:DropDownList>
                                </div>
                                <div class="col-sm-8">
                                    Notification  
            ...
            <div id="dvimage" runat="server" class="col-sm-12">
                ...
                <div id="pnlbtnerror">
                    ...
                    <div class="col-sm-12" style="text-align: center;">
                        ...
                        <asp:Button ID="btnSaveSubmit" runat="server" CssClass="btn btn-primary" Text="Save / Submit" Width="100px" Visible="False" ValidationGroup="grpSave" OnClientClick="return AllowOneClick()" CausesValidation="False"></asp:Button>
        ...
        <div class="panel-body fixed-panel" id="grd">
            ...
            <span class="help-block"></span>
            <div class="row">
                <div id="dvDetail" runat="server" class="col-sm-12">
