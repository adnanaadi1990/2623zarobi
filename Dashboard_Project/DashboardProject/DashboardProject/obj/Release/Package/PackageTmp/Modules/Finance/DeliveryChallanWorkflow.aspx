<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="DeliveryChallanWorkflow.aspx.cs" Inherits="DashboardProject.Modules.Finance.DeliveryChallanWorkflow" %>
        ...
        $("#btnShow").click(function () {
            ...
            $("#dialog").dialog({
                ...
                open: function () {
                    ...
                    object += "</object>";
                    object = object.replace(/{FileName}/g, "../../DashboardDocument/DeliveryChallanWorkflow/" + fileName);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
     <p id="dvH" style="font-family:inherit; display:none; font-size: 35px !important;font-weight: bold;color:black; text-align:center;">Delivery Challan Workflow Report<br /><br /></p>
      <div id="pnlHD">
    <div class="container" style="width: 100%; margin-top:20px; ">
           ...
           <div class="row">
                ...
                <div class="col-sm-7">
                        <p style="font-family:inherit;font-size: 35px !important;font-weight: normal;color:hsla(160, 10%, 18%, 0.35)">Delivery Challan Workflow</p>
                </div>
                 </div>
 ...
 <asp:Button ID="btnShowFile"  CssClass="btn btn-primary" Text="Show Document" runat="server" OnClick="btnShowFile_Click" Visible="False"></asp:Button>
                                ...
                                <div class="row" style="text-align: center;">
                                    <div class="col-sm-4">
                                       ...
                                       <%--<asp:DropDownList ID="ddlEmailApproval"  CssClass="form-control" runat="server">
                                        ...
                                        <asp:DropDownList ID="ddlEmailApproval" CssClass="form-control"  runat="server"></asp:DropDownList>
                                    </div>
                                    <div class="col-sm-4">
                                       2nd Approver
        ...
        <asp:Button ID="btnSaveSubmit" runat="server" OnClientClick="return AllowOneClick()" CssClass="btn btn-primary" Text="Save / Submit" Width="102px" Visible="False" ValidationGroup="grpSave" CausesValidation="False"></asp:Button>
        <asp:Button ID="btnApproved" runat="server" OnClientClick="return AllowOneClick()" CssClass="btn btn-primary" Text="Approve" OnClick="btnApproved_Click" Width="100px" Visible="False" ></asp:Button>
              <asp:Button ID="btnReject" runat="server" OnClientClick="return AllowOneClick()" CssClass="btn btn-primary" Text="Reject" OnClick="btnReject_Click" Width="100px" Visible="False"></asp:Button>
                <asp:Button ID="btnReviewed" runat="server" OnClientClick="return AllowOneClick()" CssClass="btn btn-primary" Text="Submit"  Width="100px" Visible="False"></asp:Button>
              <asp:Button ID="btnMDA" runat="server" OnClientClick="return AllowOneClick()" CssClass="btn btn-primary" OnClick="btnMDA_Click" Text="Submit" Width="100px" Visible="False" />
