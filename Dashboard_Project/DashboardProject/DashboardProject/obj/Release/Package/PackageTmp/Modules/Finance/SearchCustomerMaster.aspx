<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="SearchCustomerMaster.aspx.cs" Inherits="ITLDashboard.Modules.Finance.SearchCustomerMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="container" style="width: 100%; margin-top: 20px;" id="dvcnt">
        <div class="row" id="pnlHD">
            ...
            <div class="col-sm-7">
                <p style="font-family: inherit; font-size: 35px !important; font-weight: normal; color: hsla(160, 10%, 18%, 0.35)">Search Customer Master</p>
            </div>
        </div>

        <div class="panel panel-default" id="pnlPC">
            <div class="panel-heading">Search Customer Master</div>
