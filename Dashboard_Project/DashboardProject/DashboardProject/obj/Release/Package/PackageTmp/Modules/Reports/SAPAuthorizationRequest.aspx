<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="SAPAuthorizationRequest.aspx.cs" Inherits="ITLDashboard.Modules.Reports.SAPAuthorizationRequest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="container" style="width: 100%; margin-top: 20px;">
        <div class="row">
            ...
            <div class="col-sm-7">
                <p style="font-family: inherit; font-size: 35px !important; font-weight: normal; color: hsla(160, 10%, 18%, 0.35)">SAP Authorization Report</p>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4" runat="server" id="dvFormID">
                     ...
                     <div class="col-sm-4" runat="server" id="Div1">
                        Module
                                     <asp:DropDownList ID="ddlDBModules" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlDBModules_SelectedIndexChanged" AutoPostBack="True">
                     ...
                     <div class="col-sm-4" runat="server" id="Div2">
                         TCode
                                 <asp:DropDownList ID="ddlTCode" runat="server" CssClass="form-control" AppendDataBoundItems="True"></asp:DropDownList>
                    </div>
                        <div class="col-sm-4" runat="server" id="dvRR" visible="false">
                                Report TCode
                                    <asp:TextBox ID="TxtReportTCode" runat="server" CssClass="form-control" CausesValidation="True"></asp:TextBox>
                            </div>
                </div>
                                ...
                                <telerik:RadGrid ID="RadGrid1" runat="server" AllowFilteringByColumn="True"
                                    ...
                                    <MasterTableView AllowFilteringByColumn="False" GroupLoadMode="Client" HierarchyLoadMode="Client" ShowGroupFooter="True" CssClass="AutoShrink">
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="TCode" FilterControlAltText="Filter column2 column" HeaderText="TCode" UniqueName="column2">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="Modules" FilterControlAltText="Filter column3 column" HeaderText="Modules" UniqueName="column3">
                                            </telerik:GridBoundColumn>

                                            <telerik:GridBoundColumn DataField="ReportRequester" FilterControlAltText="Filter column4 column" HeaderText="Report" UniqueName="column4">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="Plant" FilterControlAltText="Filter column5 column" HeaderText="Plant" UniqueName="column5">
                                            </telerik:GridBoundColumn>
