...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container" style="width: 100%; margin-top: 20px;">
        <div class="row">
            ...
            <div class="col-sm-7">
                <p style="font-family: inherit; font-size: 35px !important; font-weight: normal; color: hsla(160, 10%, 18%, 0.35)">Create Material Master Report</p>
            </div>
        </div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">Create Material Master Report</div>
