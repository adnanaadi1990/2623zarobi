<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="DeadStock.aspx.cs" Inherits="ITLDashboard.Modules.Inventorymanagement.DeadStock" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
   ...
   <%--  <script>
         function loop() {
             ...
             // var list = $('#<%= ddlNotification.ClientID %>').val();
             var list = document.getElementById("<%=ddlNotification.ClientID%>");

             //   var chkBox = document.getElementById('chk');
             // if (chk.checked) {
             for (var i = 0; i < list.options.length; ++i) {
                 list.options[i].selected = false;
                 document.getElementById("<%=ddlNotification.ClientID%>").options[i].disabled = false;
             }
         }
    </script>--%>
    <script type="text/javascript">
        $(function () {
            ...
            $('[id*=ddlNotification]').removeClass('disable');
            ...
            <div id="pnlPC">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7" id="pnlHD">
                        <p style="font-family: inherit; font-size: 35px !important; font-weight: normal; color: hsla(160, 10%, 18%, 0.35)">Dead Stock Approval</p>
                    </div>
                </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row" style="text-align: center;">
                                    ...
                                    <div class="col-sm-4">
                                        Specific (Approver)  
                                       <asp:ListBox ID="ddlNotification" SelectionMode="Multiple" runat="server" Enabled="true"></asp:ListBox>
                                    </div>
                                    <div class="col-sm-4">
                                        IS Representative  
