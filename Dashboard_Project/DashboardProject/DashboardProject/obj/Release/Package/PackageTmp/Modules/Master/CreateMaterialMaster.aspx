<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="CreateMaterialMaster.aspx.cs" Inherits="ITLDashboard.Modules.Master.CreateMaterialMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container" style="width: 100%; margin-top: 20px;">
        ...
        <div class="row">
            ...
            <div class="col-sm-7">
                <p style="font-family: inherit; font-size: 35px !important; font-weight: normal; color: hsla(160, 10%, 18%, 0.35)">Create Material Master</p>
            </div>
        </div>
                ...
                <div id="collapse6" class="panel-collapse collapse in">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-4">
                                Valuation Class
                                    &nbsp;<asp:DropDownList ID="ddlValuationClass" runat="server" CssClass="form-control">
                                    </asp:DropDownList>
                            </div>
                            <div class="col-sm-4">
                                Valuation Category
                            ...
                            <div class="col-sm-4">
                               ...
                               <div class="col-sm-4"  runat="server" visible="false" id="dvSTprice">
                                Standard Price
                    ...
                    <div class="panel-body">
                        <div class="row" style="text-align: center;">
                            ...
                            <div id="Div1" class="col-sm-3" runat="server" visible="false">
                                Review By
                                        &nbsp;<asp:DropDownList ID="ddlEmailReviwer" runat="server" OnSelectedIndexChanged="ddlEmailReviwer_SelectedIndexChanged"></asp:DropDownList>
                            </div>
                            ...
                            <div class="col-sm-3">
                                Master Data Administrator
                                        <asp:DropDownList ID="ddlEmailMDA" runat="server" OnSelectedIndexChanged="ddlEmailMDA_SelectedIndexChanged"></asp:DropDownList>
                            </div>
