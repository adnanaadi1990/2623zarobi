<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="SearchMaterialMasterMtypeCreation.aspx.cs" Inherits="DashboardProject.Modules.Master.SearchMaterialMasterMtypeCreation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="row" id="pnlHD">
            ...
            <div class="col-sm-7">
                <p style="font-family: inherit; font-size: 35px !important; font-weight: normal; color: hsla(160, 10%, 18%, 0.35)">Search Finished Material Master</p>
            </div>
        </div>
