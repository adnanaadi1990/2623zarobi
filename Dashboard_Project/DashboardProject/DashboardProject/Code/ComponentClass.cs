    ...
    public class ComponentClass
    {
        ...
        public DataSet getUserDetail(string UserNameID)
        {
            try
            {
                ds.Clear();
                cmd.CommandText = "";
                cmd.CommandText = "select DisplayName,Department from tbluser where user_name = '" + UserNameID.ToString() + "'";
                cmd.CommandType = CommandType.Text;
                cmd.Connection = conn;
                adp.SelectCommand = cmd;
        ...
        public DataSet getPlantDistinct()
        {
            try
            {
                ...
                ds.Clear();
                cmd.CommandText = "";
                cmd.CommandText = "select Distinct PlantId, PlantId + ' ' + Description as Description from tblPlants";
                cmd.CommandType = CommandType.Text;
                cmd.Connection = conn;
                adp.SelectCommand = cmd;
