<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="CRBooking.aspx.cs" Inherits="DashboardProject.Modules.HR.CRBooking" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="width: 100%; margin-top: 20px;">
        ...
        <div class="row">
            ...
            <div class="col-sm-7">
                <p style="font-family: inherit; font-size: 35px !important; font-weight: normal; color: hsla(160, 10%, 18%, 0.35)">Conference Room Booking</p>
                ...
                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <asp:RadioButtonList ID="rbType" runat="server" RepeatDirection="Horizontal" AutoPostBack="True">
                                    <asp:ListItem Value="MCR" Selected="True">Main Conference Room</asp:ListItem>
                                    <asp:ListItem Value="ECR">Executive Conference Room</asp:ListItem>
                                </asp:RadioButtonList>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                Time From
                                    <asp:TextBox ID="txtTimeFrom" runat="server" CssClass="form-control" CausesValidation="True" MaxLength="8" TextMode="Time"></asp:TextBox>
                            </div>

                            <div class="col-sm-4">
                                Time To
                                    <%--<%# Eval("Lenght") %>--%>
                                <asp:TextBox ID="txtTimeTo" runat="server" CssClass="form-control" TextMode="Time"></asp:TextBox>
                                <%--<%# Eval("Lenght") %>--%>
                            </div>
                        </div>
                        <span class="help-block"></span>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <asp:GridView ID="GridView1" CssClass="table table-hover table-bordered footable" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True">
                                    <EmptyDataTemplate>
                                        No Data</td>
                                    </EmptyDataTemplate>
                                    <Columns>
                                        <asp:TemplateField HeaderText="Booking Date" SortExpression="BookingDate">
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblDate" Text='<%# Bind("BookingDate") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="15%" />
                                        ...
                                        <asp:TemplateField HeaderText="Time From" SortExpression="TimeFrom">
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblTimeFrom" Text='<%# Bind("TimeFrom") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="14%" />
                                            <HeaderStyle Width="14%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Time To" SortExpression="TimeTo">
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblTimeTo" Text='<%# Bind("TimeTo") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="14%" />
                                            <HeaderStyle Width="14%" />
                                        </asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblPurpose" Text='<%# Bind("Purpose") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="14%" />
                                            <HeaderStyle Width="14%" />
                                        </asp:TemplateField>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" style="text-align: center;">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                HR & OD
                                <asp:DropDownList ID="ddlHr" CssClass="form-control" runat="server">
                                </asp:DropDownList>
                            </div>
                            <div class="col-sm-4"></div>
                        </div>
