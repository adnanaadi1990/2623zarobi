...
{
    public partial class SearchDeadStock : System.Web.UI.Page
    {
        ...
        public static string FormID = "601";
        ...
        protected void getFileName()
        {
            ...
            {
                string Link = "";
                cmd.CommandText = @"select top(1) TransactionMain,TransactionID from tbl_DeadStock where TransactionID = @TNo";
                ...
                if (ds.Tables["Data"].Rows.Count > 0)
                {
                    ...
                    Response.Redirect("~/Modules/Inventorymanagement/DeadStock.aspx?TransactionNo=" + Link.ToString());
                }
                else
                {
