...
namespace ITLDashboard.Modules.Inventorymanagement
{
    public partial class DeadStock : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                ...
                try
                {
                    ...
                    if (Request.QueryString["TransactionNo"] != null)
                    {
                        ...
                        cmd.CommandText = @" SELECT * from  tbl_DeadStock where TransactionMain = @TNo";
        ...
        protected void btnUpload_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    fleUpload.PostedFile.SaveAs(Server.MapPath("~/DashboardDocument/DeadStockDoc/" + character.ToString() + "_" + filename));
        ...
        protected void btnShowFile_Click(object sender, EventArgs e)
        {
            ...
            lblError.Text = "";
            string pdfFileToDisplay = "../../DashboardDocument/DeadStockDoc/" + lblFileName.Text;
            string pdfFileToDisplay1 = "DashboardDocument/DeadStockDoc/" + lblFileName.Text;
        ...
        {
            cmd.CommandText = @"update tbl_DeadStock set DocumentNo = @DocumentNo
        ...
        private void EmailWorkSendFirstApproval()
        {
            ...
            if (ds.Tables["MailForwardUserToApprover"].Rows.Count > 0)
            {
                ...
                while (reader.Read())
                {
                    ...
                    EmailSubject = "Dead Stock Approval Request – Form ID # " + lblMaxTransactionID.Text.ToString() + "";
                    EmailBody = "Dear Mr " + "" + UserName.ToString() + ",<br> <br>   " + ViewState["SessionUser"].ToString() + ",<br> <br>   " + ViewState["SessionUser"].ToString() + " has sent you a dead stock approval against  Form ID # " + lblMaxTransactionID.Text.ToString() + " for approval. <br><br> Your kind approval is required on the following URL:" +
        ...
        private void EmailWorkFirstHaracheyMDA()
        {
            ...
            if (ds.Tables["MailForwardToAllFromMDA"].Rows.Count > 0)
            {
                ...
                while (reader.Read())
                {
                    ...
                    EmailBody = "Dear Mr " + "" + UserName.ToString() + ",<br><br> Authorization has been issued against  User Authorization Request Form ID # " + lblMaxTransactionID.Text.ToString() + " <br><br> The form can be reviewed at the following URL:<br> <a href =" + url.ToString() + ">" + url.ToString() + "</a> <br> <br>  This is an auto-generated email from IS Dashboard,<br> you do not need to reply to this message." +
        ...
        private void EmailWorkApproved()
        {
            ...
            if (ds.Tables["MailForwardFormApprover"].Rows.Count > 0 && Value == "2")
            {
                while (reader.Read())
                {
                    ...
                    UserEmail = reader["user_email"].ToString(); //ViewState["SessionUser"].ToString();
                    EmailSubject = "Dead Stock Approval Request – Form ID # " + lblMaxTransactionID.Text.ToString() + "";
                    EmailBody = "Dear Mr " + "" + UserName.ToString() + ",<br> <br>   " + ViewState["SessionUser"].ToString() + ",<br> <br> Dead Stock Approval Request against  Form ID #  " + lblMaxTransactionID.Text.ToString() + " has been approved by " + ViewState["SessionUser"].ToString() + " <br> <br> > Your kind approval is required on the following URL: " +
                    "The form can be reviewed at the following URL within ITL Network:<br><a href =" + url.ToString() + ">" + url.ToString() + "</a> <br> <br>" +
                    "To access the form outside ITL network, please use the following URL:<br><a href =" + urlMobile.ToString() + ">" + urlMobile.ToString() + "</a> <br> <br> " +
                    "This is an auto-generated email from IS Dashboard,<br> you do not need to reply to this message." +
                    "<br>Inventory Management Application <br> Information Systems Dashboard";
                    ...
                    DateTimeNow = DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss");
                    InsertEmail();
                    lblEmail.Text = "Dead Stock Request against  Form ID # " + lblMaxTransactionID.Text.ToString() + " has been approved by you";
            ...
            else
            {
                if (ds.Tables["MailForwardFormApprover"].Rows.Count > 0)
                {
                    while (reader.Read())
                    {
                        ...
                        UserEmail = reader["user_email"].ToString(); //ViewState["SessionUser"].ToString();
                        EmailSubject = "User Authorization Request – Form ID # " + lblMaxTransactionID.Text.ToString() + "";
                        EmailBody = "Dear Mr " + "" + UserName.ToString() + ",<br> <br> Dead Stock Request against  Form ID #  " + lblMaxTransactionID.Text.ToString() + " has been approved by " + ViewState["SessionUser"].ToString() + " <br><br> You can create the document no on following URL:<br>  <a href =" + url.ToString() + ">" + url.ToString() + "</a> <br> <br> This is an auto-generated email from IS Dashboard,<br> you do not need to reply to this message.<br>" +
                              "<br>Inventory Management Application <br> Information Systems Dashboard";
                        SessionUser = Session["User_Name"].ToString();
                        DateTimeNow = DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss");
                        InsertEmail();
        ...
        private void EmailWorkReject()
        {
            ...
            if (ds.Tables["MailForwardToUserOnRejection"].Rows.Count > 0)
            {
                ...
                while (reader.Read())
                {
                    ...
                    UserName = reader["user_name"].ToString();
                    UserEmail = reader["user_email"].ToString(); //ViewState["SessionUser"].ToString();
                    EmailSubject = "Dead Stock Request against  Form ID #" + lblMaxTransactionID.Text.ToString() + "";
                    EmailBody = "Dear Mr " + "" + UserName.ToString() + ",<br> <br>   " + ViewState["SessionUser"].ToString() + ",<br> <br> Dead Stock Request against  Form ID # " + lblMaxTransactionID.Text.ToString() + " has been disapproved by  " + ViewState["SessionUser"].ToString() + " <br><br> The reason of rejection is given below you can review your form on following url: " +
                    "The form can be reviewed at the following URL within ITL Network:<br><a href =" + url.ToString() + ">" + url.ToString() + "</a> <br> <br>" +
                    "To access the form outside ITL network, please use the following URL:<br><a href =" + urlMobile.ToString() + ">" + urlMobile.ToString() + "</a> <br> <br> " +
                    "This is an auto-generated email from IS Dashboard,<br> you do not need to reply to this message." +
                    "<br>Inventory Management Application <br> Information Systems Dashboard";
            ...
            try
            {
                ...
                if (ds.Tables["MailForwardToAllFromMDA"].Rows.Count > 0)
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        UserName = reader["user_name"].ToString();
                        UserEmail = reader["user_email"].ToString(); //ViewState["SessionUser"].ToString();
                        EmailSubject = "Dead Stock Request – Form ID # " + lblMaxTransactionID.Text.ToString() + "";
                        EmailBody = "Dear Mr " + "" + UserName.ToString() + ",<br> <br>   " + ViewState["SessionUser"].ToString() + ",<br> <br>  Documnet No " + txtDocNo.Text + " has been  created by " + ViewState["SessionUser"].ToString().Replace(".", " ") + "  against  Dead Stock Request Form ID # " + lblMaxTransactionID.Text.ToString() + " <br><br> The form can be reviewed at the following URL:" +
                        "The form can be reviewed at the following URL within ITL Network:<br><a href =" + url.ToString() + ">" + url.ToString() + "</a> <br> <br>" +
                        "To access the form outside ITL network, please use the following URL:<br><a href =" + urlMobile.ToString() + ">" + urlMobile.ToString() + "</a> <br> <br> " +
                        "This is an auto-generated email from IS Dashboard,<br> you do not need to reply to this message." +
                        "<br>Inventory Management Application <br> Information Systems Dashboard";
