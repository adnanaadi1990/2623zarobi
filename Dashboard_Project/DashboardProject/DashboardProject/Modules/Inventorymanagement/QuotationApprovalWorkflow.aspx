<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="QuotationApprovalWorkflow.aspx.cs" Inherits="DashboardProject.Modules.Inventorymanagement.QuotationApprovalWorkflow" %>
            ...
            <div id="pnlPC">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7" id="pnlHD">
                        <p style="font-family: inherit; font-size: 35px !important; font-weight: normal; color: hsla(160, 10%, 18%, 0.35)">Quotation Approval Workflow</p>
                    </div>
                </div>
