<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="UserAuthorizationRequest.aspx.cs" Inherits="ITLDashboard.Modules.SBApp.UserAuthorizationRequest" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////
        function pageLoad() {
            $('[id*=ddlTCode],[id*=ddlStorageLocation],[id*=ddlPlant],[id*=ddlSAPID],[id*=ddlMovementType],[id*=ddlOrderType],[id*=ddlRoles]').multiselect({
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container" style="width: 100%; margin-top: 20px;">
        ...
        <div class="row">
            ...
            <div class="col-sm-7">
                <p style="font-family: inherit; font-size: 35px !important; font-weight: normal; color: hsla(160, 10%, 18%, 0.35)">SAP Authorization Form</p>
                ...
                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel">
                    <div class="panel-body">
                        ...
                        <div class="row" id="dvAllowForm" runat="server">
                            <div class="col-sm-4">
                                Modules
                                     <asp:DropDownList ID="ddlDBModules" runat="server" AutoPostBack="True" CssClass="form-control" OnSelectedIndexChanged="ddlDBModules_SelectedIndexChanged">
                            ...
                            <div class="col-sm-7" runat="server" id="dvTcode">
                                TCode                     
                                 <asp:ListBox ID="ddlTCode" runat="server" CssClass="form-control" SelectionMode="Multiple" AppendDataBoundItems="True"></asp:ListBox>
                            </div>
        ...
        <div class="panel-group" id="Rolesauthorization" runat="server" visible="false">
            <div class="panel panel-default">
                <div class="panel-heading">
                    Roles Authorization
                </div>
                <div id="Div2" class="panel-collapse collapse in" role="tabpanel">
                    <div class="panel-body">
                        <div class="row" id="dvRestricted" runat="server">
                            <div class="col-sm-4">
                                Roles
                         ...
                         <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            ...
                            <div class="col-sm-4">
                                Movement Type
                              <asp:ListBox ID="ddlMovementType" runat="server" SelectionMode="Multiple"></asp:ListBox>
                            </div>
                            <div class="col-sm-4">
                                Order Type
                              <asp:ListBox ID="ddlOrderType" runat="server" SelectionMode="Multiple"></asp:ListBox>
                            </div>
                        </div>
                    </div>
                </div>
