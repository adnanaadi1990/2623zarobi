...
{
    public partial class SearchAssetWritteoffForm : System.Web.UI.Page
    {
        ...
        public static string FormID = "AWOF501";
        ...
        protected void getFileName()
        {
            ...
            {
                string Link = "";
                cmd.CommandText = @"select top(1) TransactionMain,TransactionID from tbl_AssetWriteOffForm where TransactionID = @TNo";
                cmd.CommandType = CommandType.Text;
                cmd.Connection = conn;
                ...
                if (ds.Tables["Data"].Rows.Count > 0)
                {
                    ...
                    Response.Redirect("~/Modules/Annexure/AssetWriteoffForm.aspx?TransactionNo=" + Link.ToString());
                }
                else
                {
                    lblError.Text = "No Data Found!";
