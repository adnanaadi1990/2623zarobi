...
{
    public partial class SearchAssetsDisposalform : System.Web.UI.Page
    {
        ...
        public static string FormID = "ADF501";
        ...
        protected void getFileName()
        {
            ...
            {
                string Link = "";
                cmd.CommandText = @"select top(1) TransactionMain,TransactionID from tbl_AssestsDisposalForm where TransactionID = @TNo";
                cmd.CommandType = CommandType.Text;
                cmd.Connection = conn;
                ...
                if (ds.Tables["Data"].Rows.Count > 0)
                {
                    ...
                    Response.Redirect("~/Modules/Annexure/AssestsDisposalForm.aspx?TransactionNo=" + Link.ToString());
                }
                else
                {
                    lblError.Text = "No Data Found!";
