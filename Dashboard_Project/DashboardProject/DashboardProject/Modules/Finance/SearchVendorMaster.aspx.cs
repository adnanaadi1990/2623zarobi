...
{
    public partial class SearchVendorMaster : System.Web.UI.Page
    {
        ...
        protected void getFileName()
        {
            ...
            {
                string Link = "";
                cmd.CommandText = @"select top(1) TransactionMain,TransactionID from tbl_FI_VendorMaster where TransactionID = @TNo";
                ...
                if (ds.Tables["Data"].Rows.Count > 0)
                {
                    ...
                    Response.Redirect("~/Modules/Finance/VendorMaster.aspx?TransactionNo=" + Link.ToString());
                }
                else
                {
