                ...
                <div id="dvimage" runat="server" class="col-sm-12">
                    ...
                    <div id="pnlbtnerror">
                        ...
                        <div class="col-sm-12" style="text-align: center;">
                            ...
                            <asp:Button ID="btnApproved" runat="server" CssClass="btn btn-primary" Text="Approve" OnClick="btnApproved_Click" Width="100px" OnClientClick="return AllowOneClick()" Visible="False"></asp:Button>
                            <%--<%# Eval("Width") %>--%>
