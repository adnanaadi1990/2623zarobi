...
{
    public partial class SearchBOMApproval : System.Web.UI.Page
    {
        ...
        public static string FormID = "102";
        ...
        protected void getFileName()
        {
            ...
            {
                string Link = "";
                cmd.CommandText = @"select top(1) TransactionMain,TransactionID from tbl_BOM_Approval_Header where TransactionID = @TNo";
                ...
                if (ds.Tables["Data"].Rows.Count > 0)
                {
                    ...
                    Response.Redirect("~/Modules/Master/BOMApproval.aspx?TransactionNo=" + Link.ToString());
                }
                else
                {
