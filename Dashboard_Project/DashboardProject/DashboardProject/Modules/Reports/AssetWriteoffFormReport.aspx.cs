...
{
    public partial class AssetWriteoffFormReport : System.Web.UI.Page
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ds.Clear();
                cmd.CommandText = "";
                cmd.CommandText = @"SP_AssetWriteOffFormreport";
                ...
                cmd.Parameters.AddWithValue("@DateofWriteOff", txtDateofWriteOff.Text);
