...
{
    public partial class ServiceMasterRequestformReport : System.Web.UI.Page
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ds.Clear();
                cmd.CommandText = "";
                cmd.CommandText = @"SP_ServiceMasterformreport";
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Connection = conn;
                cmd.Parameters.AddWithValue("@FormIDFrom", txtFormIDfrom.Text);
                cmd.Parameters.AddWithValue("@FormIDto", txtFormIDto.Text);
                cmd.Parameters.AddWithValue("@ServiceMasterCode", txtSMC.Text);
                cmd.Parameters.AddWithValue("@ServiceCategory", ddlServiceCategory.SelectedValue.ToString());
                cmd.Parameters.AddWithValue("@MSG", ddlMSG.SelectedValue.ToString());
                cmd.Parameters.AddWithValue("@Division", ddlDivision.SelectedValue.ToString());
                cmd.Parameters.AddWithValue("@ValuationClass", ddlValuation.SelectedValue.ToString());
        ...
        private void BindServiceCategory()
        {
            ...
            ddlServiceCategory.Items.Insert(0, new ListItem("------Select------", ""));
        }
        ...
        private void BindMaterialGroup()
        {
            ...
            ddlMSG.Items.Insert(0, new ListItem("------Select------", ""));
        }
