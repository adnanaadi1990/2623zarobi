...
{
    public partial class MaterialMasterReport : System.Web.UI.Page
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@SapMaterialcode", txtSMC.Text);
                ...
                cmd.Parameters.AddWithValue("@Reviewer", txtReviewer.Text);
                cmd.Parameters.AddWithValue("@MDA", txtMDA.Text);
                cmd.Parameters.AddWithValue("@Materialtype", txtMT.Text);
                cmd.Parameters.AddWithValue("@Materialgroup", txtMG.Text);
