    ...
    public partial class CustomerMasterReport : System.Web.UI.Page
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@Accountgroup", ddlAccountGroup.SelectedValue.ToString().Replace("0", ""));
                cmd.Parameters.AddWithValue("@Customercode", txtCMC.Text);
        ...
        protected void RadGrid1_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Select")
            {
                if (e.Item is GridDataItem)
                {
                    ...
                    win.NavigateUrl = "~/Modules/Reports/StatusDetailCustomer.aspx?TransactionNo=" + str.ToString() + "&FormName=" + FormID.ToString() + "";
